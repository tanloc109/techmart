...
@WebServlet(name = "ReportRevenueByYearController", urlPatterns = {"/ReportRevenueByYearController"})
public class ReportRevenueByYearController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (revenue >= 0) {
                request.setAttribute("REVENUEBYYEAR", revenue);
                url = SUCCESS;
            }
        } catch (Exception e) {
