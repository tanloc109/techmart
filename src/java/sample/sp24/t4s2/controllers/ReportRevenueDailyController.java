...
@WebServlet(name = "ReportRevenueDailyController", urlPatterns = {"/ReportRevenueDailyController"})
public class ReportRevenueDailyController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            list = revenueDAO.getRevenueReportDaily();
            if(list != null && list.size() > 0) {
                request.setAttribute("LIST_REVENUE_DAILY", list);
                url = SUCCESS;
            }
        } catch (Exception e) {
