...
@WebServlet(name = "ReportRevenueYearlyController", urlPatterns = {"/ReportRevenueYearlyController"})
public class ReportRevenueYearlyController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            list = revenueDAO.getRevenueReportYearly();
            if(list != null && list.size() > 0) {
                request.setAttribute("LIST_REVENUE_YEARLY", list);
                url = SUCCESS;
            }
        } catch (Exception e) {
