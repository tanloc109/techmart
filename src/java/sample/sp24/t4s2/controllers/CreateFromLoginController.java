...
@WebServlet(name = "CreateFromLoginController", urlPatterns = {"/CreateFromLoginController"})
public class CreateFromLoginController extends HttpServlet {

    public static final String ERROR = "createUserFromLogin.jsp";
