...
@WebServlet(name = "ReportRevenueByDayController", urlPatterns = {"/ReportRevenueByDayController"})
public class ReportRevenueByDayController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = ERROR;
        try {
            Date date = Date.valueOf(request.getParameter("search"));
            RevenueDAO revenueDAO = new RevenueDAO();
            double revenue = revenueDAO.getRevenueByDay(date);
            if(revenue >= 0) {
