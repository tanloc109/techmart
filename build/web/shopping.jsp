            ...
            <c:if test="${requestScope.LIST_PRODUCT != null}">
                <c:if test="${not empty requestScope.LIST_PRODUCT}">
                                ...
                                <form action="MainController">
                                    <tr>
                                        <td class="text-center">
                                            ...
                                            <input type="hidden" name="memory" value="${product.getMemory()}"/>
                                        </td>
                    ...
                    <div class="shopping-cart-footer">
                        <div class="column"><a class="btn btn-outline-secondary" href="MainController?action=HomeUser"><i class="icon-arrow-left"></i>&nbsp;Back to User</a></div>
                        <div class="column"><a class="btn btn-success" href="MainController?action=View">View Cart</a></div>
                    </div>
